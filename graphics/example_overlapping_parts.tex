...
\draw[draw, fill=ACMDarkBlue, fill opacity=0.3] \hedgem{v2}{v1}{v3}{6mm};
\draw[draw, fill=ACMDarkBlue, fill opacity=0.3] \hedgem{v2}{v1}{v4}{6mm};
\draw[draw, fill=ACMDarkBlue, fill opacity=0.3] \hedgem{v2}{v1}{v5}{6mm};

\draw[draw, fill=ACMRed, fill opacity=0.5] \hedgem{v3}{v4}{v5}{6mm};
